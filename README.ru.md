...
Теоретически второй вариант должен быть производительнее, так как не
создаёт замыкание на каждом вызове. Но на практике компилятор сводит
разницу к минимуму.
...
интерполяцией или что-то вроде `i++`. Лучше перестраховаться.
...
`print` всегда пишет в stdout, поэтому вывод ошибок подмешивается
в обычный вывод программы. Дайте уровню ошибок собственный паблишер:
